    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
                ...
                <a
                    href="{{ Auth::user()->rol_id === 2
                        ...
                        : (Auth::user()->rol_id === 3
                            ...
                            : route('dashboard')) }}">
                    <x-application-logo
                        class="block h-16 w-auto object-contain fill-current text-gray-800 dark:text-gray-200" />
                </a>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                if (localStorage.getItem('theme') === 'dark') document.documentElement.classList.add('dark');" @click="toggle()" type="button"
    ...
    <div :class="{ 'block': open, 'hidden': !open }"
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                if (localStorage.getItem('theme') === 'dark') document.documentElement.classList.add('dark');" @click="toggle()"
                    ...
                    <svg x-show="!darkMode" class="w-5 h-5 me-2" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path>
                    </svg>
                    <svg x-show="darkMode" class="w-5 h-5 me-2" fill="currentColor" viewBox="0 0 20 20">
                        <path
