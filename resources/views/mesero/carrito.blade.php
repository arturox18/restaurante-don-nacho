            ...
            @else
                ...
                <div class="flex flex-col gap-3">
                    <form action="{{ route('mesero.confirmar', $mesa) }}" method="POST">
                        @csrf
                        <button type="submit"
                            class="w-full bg-gray-900 text-white hover:bg-gray-800 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-100 font-bold py-4 rounded-xl text-center shadow-lg transition transform active:scale-95">
                            Mandar a cocinero
                        </button>
                    </form>
